...
# # Tạo danh sách enemy
# def create_enemies():
#     enemy = En.Enemy(300,100,item.Boss,1000)
#     enemies.append(enemy)
#
# def show_score(x,y,type):
#     if type == 1:
#         score = Fonttext.render("Score: " + str(player.score_value), True, (255, 0, 0))
#         mainscreen.SCREEN.blit(score, (x, y))
#     if type == 2:
#         score1 = Fonttext.render("Score: " + str(player1.score_value), True, (255, 0, 0))
#         score2 = Fonttext.render("Score: " + str(player2.score_value), True, (255, 0, 0))
